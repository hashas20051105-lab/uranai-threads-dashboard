...
-- Run after all Supabase migrations.
...
insert into public.keywords (user_id, account_id, keyword, category, priority, is_active, source) values
...
insert into public.keyword_packs (user_id, account_id, pack_name, pack_type, keywords, is_enabled, memo) values
